...
const Hero = () => {
  return (
    ...
    <section
      id="home"
      className="relative z-10 overflow-hidden h-screen bg-white dark:bg-gray-dark"
    >
      <Image src="/images/hero/leax-city.webp" alt="hero" className="object-cover" fill />
        ...
        <div className="-mx-4 flex flex-wrap">
          <div className="w-full px-4 z-10">
            <div className="mx-auto max-w-[800px] text-center">
              ...
              <MotionWrapper variants={animations.link1} >
                <Link
                ...
                <MotionWrapper variants={animations.link2} >
                <Link
